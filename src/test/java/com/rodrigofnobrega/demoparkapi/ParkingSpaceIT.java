...
public class ParkingSpaceIT {
    ...
    public void criarVaga_ComDadosValidos_RetornarLocationStatus201() {
        ...
        testClient
                ...
                .bodyValue(new ParkingSpaceCreateDTO("A-05", "LIVRE"))
                .exchange()
    ...
    public void criarVaga_ComCodigoJaExistente_RetornarErrorMessageComStatus409() {
        ...
        testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
                .bodyValue(new ParkingSpaceCreateDTO("A-01", "LIVRE"))
                .exchange()
    ...
    public void criarVaga_ComDadoInvalidos_RetornarErrorMessageComStatus422() {
        ...
        testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
                .bodyValue(new ParkingSpaceCreateDTO("A-501", "DESOCUPADA"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody()
                .jsonPath("status").isEqualTo(422)
    ...
    public void criarVaga_ComUsuarioSemPermissaoDeAcesso_RetornarErrorMessageComStatus403() {
        ...
        testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bia@email.com", "123456"))
                .bodyValue(new ParkingSpaceCreateDTO("A-05", "OCUPADA"))
                .exchange()
                .expectStatus().isForbidden()
                .expectBody()
                .jsonPath("status").isEqualTo(403)
